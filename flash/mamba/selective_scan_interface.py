...
print(f"selective_scan: free_memory_gb {free_memory_gb}, max_jobs {os.environ['MAX_JOBS']}")
...
selective_scan_cuda = torch.utils.cpp_extension.load(
    "CUTE_selective_scan_cuda",
    sources=[
        abspath/"selective_scan.cpp",
        abspath/"selective_scan_fwd_bf16.cu",
        abspath/"selective_scan_bwd_bf16_real.cu",
        abspath/"selective_scan_bwd_bf16_complex.cu",
    ],
    extra_cuda_cflags=NVCC_FLAGS,
    extra_include_paths=[ str(abspath) ],
)
# ~/.cache/torch_extensions/...
print(f"selective_scan: DONE. In {int(time.time() - started_at)} seconds.")
#########################################################################
