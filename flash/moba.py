# https://raw.githubusercontent.com/MoonshotAI/MoBA/refs/heads/master/moba/moba_efficient.py
...
def moba_attn_varlen(
    ...
    """An efficient version of moba implementation with flash-attn, the core logic:
