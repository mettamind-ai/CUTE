...
try: print('RWKV_MY_TESTING', os.environ["RWKV_MY_TESTING"])
except: os.environ["RWKV_MY_TESTING"] = ''

try: print('RWKV_HEAD_SIZE', os.environ["RWKV_HEAD_SIZE"])
except: os.environ["RWKV_HEAD_SIZE"] = "8"
...
if 'x070' in os.environ["RWKV_MY_TESTING"]:
    ...
    load(name="wind_backstepping", sources=['wkv7.cu', 'wkv7.cpp'], 
