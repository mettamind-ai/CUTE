''' https://github.com/zhixuan-lin/forgetting-transformer/blob/main/src/forgetting_transformer/ops/forgetting_attention.py
- support varlen https://github.com/fla-org/flash-linear-attention/blob/main/fla/ops/forgetting_attn/parallel.py
- https://www.alphaxiv.org/abs/2503.02130
- https://youtu.be/W7hoMvAHgbs
- https://asap-seminar.github.io/assets/slides/fox-asap.pdf
'''
import pytest
import math
import torch
