...
## Install qllmt from https://github.com/IST-DASLab/HALO
git clone https://github.com/NVIDIA/cutlass.git
python3 setup.py install
rm -rf CMakeFiles CMakeCache.txt CPackConfig.cmake CPackSourceConfig.cmake Makefile cmake_install.cmake ctest/ build/ dist/ qllmt.egg-info/
