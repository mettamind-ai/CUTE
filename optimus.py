...
Muon optimizer modified from github.com/nil0x9/flash-muon

Hai hàm quan trọng nhất là:
- `scaled_mm_kernel` phép nhân ma trận nhanh sử dụng int8
- `matmul_transpose_kernel` phép nhân ma trận chuyển vị để tính newtonschulz
  nhanh hơn trong Muon (flash_muon)
