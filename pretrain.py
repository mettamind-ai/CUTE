...
model = WinGPT( dim=1024, expansion=3, n_layers=24, num_heads=16, num_kv_heads=4, head_dim=64,
                vocab_size=args.vocab, max_seq_len=tokens_per_batch) # ~300m; config ~= qwen3 0.6b
